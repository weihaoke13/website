                ...
                <Grid>
                    <Cell col={4} >
                        <div style={{textAlign:'center'}}>
                            <img className='avatar-img' src=" https://scontent-lax3-1.xx.fbcdn.net/v/t1.0-9/71679939_2464225650331507_4169363528639053824_n.jpg?_nc_cat=101&ccb=2&_nc_sid=09cbfe&_nc_ohc=6FYD4kFeGY0AX_Y7zEc&_nc_ht=scontent-lax3-1.xx&oh=1a098482c738bb3601ed5a6f82f59407&oe=5FCEE3D5"
                             alt="avatar"
                             style={{height:'200px'}}
                            />
                        </div>
